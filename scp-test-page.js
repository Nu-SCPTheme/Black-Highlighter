...
$(function () {
	...
	fetch("./css/black-highlighter.css")
		.then((resp) => {
			...
			switch (resp) {
				case "OK":
					return (styleSheets = ["./css/normalize.css", "./css/black-highlighter.css"]);
				default:
					return (styleSheets = ["/Black-Highlighter/css/normalize.css", "/Black-Highlighter/css/black-highlighter.css"]);
			}
		})
	...
	(function (DOMParser) {
		...
		try {
			...
			console.error(`Polyfill for DOMParser Error: ${ex}`);
		}
